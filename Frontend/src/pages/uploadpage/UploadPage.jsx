    ...
    <div className="upload-page">
      ...
      <div className="upload-container">
        ...
        <div className="upload-header">
          <div className="logo-badge" style={{ padding: '0', background: 'transparent', outline: 'none' }}>
            <img src={logoImg} alt="CipherSearch Logo" style={{ width: '40px', height: '40px', objectFit: 'contain' }} />
          </div>
              ...
              >
                {isUploading ? (
                  <>
                    ...
                    <span>Encrypting & Syncing to Cloud...</span>
                  </>
                ) : (
                  <>
                    ...
                    <span>Upload & Sync to Cloud Vault</span>
                  </>
                )}
              </button>

              <p className="drop-formats">
                Supports: .txt, .pdf, .doc, .docx, .enc
              </p>
            </div>
          </div>
        </div>
